...
def add_subsidized_column():
    ...
    subsidized_financial_amadeus.to_csv("subsidized_financial_amadeus.csv",index=False)
    not_subsidized_financial_amadeus.to_csv("not_subsidized_financial_amadeus.csv",index=False)
