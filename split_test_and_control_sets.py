...
def create_orbis_control_csv():
    ...
    game_ev_members_orbis=upper_list(game_ev_members_orbis["name_native"].to_list())
    filtered_subsidized_orbis=upper_list(pd.read_csv(orbis_subsidized_filtered)["name_native"].to_list())

    game_ev_members_orbis_control=list_difference(game_ev_members_orbis,filtered_subsidized_orbis)
    ...
    mask=game_ev_members_orbis["name_native"].isin(game_ev_members_orbis_control)
...
def create_amadeus_control_csv():
    ...
    filtered_subsidized_orbis=upper_list(pd.read_csv(orbis_subsidized_filtered)["name_nat"].to_list())

    game_ev_members_orbis_control=list_difference(game_ev_members_amadeus,filtered_subsidized_orbis)
    game_ev_members_orbis_control=unique_list(game_ev_members_amadeus)

    game_ev_members_amadeus["name_nat"]=game_ev_members_amadeus["name_nat"].apply(lambda x: x.upper())
    mask=game_ev_members_amadeus["name_nat"].isin(game_ev_members_orbis_control)
