...
def complete_workflow():
    ...
    fetch_all(connection,database="amadeus") #mit all_ids und treatment columns
    fetch_all(connection,database="orbis")
    append_treatment_to_sql_data() #problem mit suffixes entsteht wenn wir nicht wrds requesten aber appenden
