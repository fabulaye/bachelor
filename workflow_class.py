...
class workflow():
    ...
    def clean(self):
        ...
        self._df.to_excel(r"C:\Users\lukas\Desktop\bachelor\data\financials_merge_treatment_and_control.xlsx")
        return self
    def drop_imputed_cols(self):
        data=pd.read_csv(r"C:\Users\lukas\Desktop\bachelor\data\financials_merge_treatment_and_control.xlsx")
        ...
        data.to_excel(r"C:\Users\lukas\Desktop\bachelor\data\financials_merge_treatment_and_control.xlsx")
        return self
    def impute(self):
        data=pd.read_excel(r"C:\Users\lukas\Desktop\bachelor\data\financials_merge_treatment_and_control.xlsx")
...
bachelor_workflow.treatment_control_workflow("treatment").treatment_control_workflow("control").merge_and_concat().categorials().clean().impute().drop_imputed_cols().match()